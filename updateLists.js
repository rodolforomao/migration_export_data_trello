        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    data = fs.readFileSync('json/list.json', 'utf8');
                ...
                case 6:
                    ...
                    return [3 /*break*/, 8];
                case 7:
                    console.log("List with ID ".concat(list.id, " already exists. Skipping insertion."));
                    _a.label = 8;
                case 8:
